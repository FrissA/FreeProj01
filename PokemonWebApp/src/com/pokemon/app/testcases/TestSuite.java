package com.pokemon.app.testcases;
...
public class TestSuite {
	String URL_BASE = "http://localhost:8080/PokemonWebApp/";

	private final static Logger testLogger = Logger.getLogger(TestSuite.class.getName());

	public static String TEST_DECK1 = "e \"Fire\"\n" + "e \"Fire\"\n" + "p \"Charizard\"\n" + "e \"Fire\"\n"
			+ "e \"Fire\"\n" + "e \"Fire\"\n" + "p \"Charizard\"\n" + "p \"Meowth\"\n" + "e \"Fire\"\n"
			+ "t \"Misty\"\n" + "t \"Misty\"\n" + "e \"Fire\"\n" + "e \"Fire\"\n" + "e \"Fire\"\n" + "p \"Charizard\"\n"
			+ "e \"Fire\"\n" + "e \"Fire\"\n" + "e \"Fire\"\n" + "p \"Charizard\"\n" + "p \"Meowth\"\n" + "e \"Fire\"\n"
			+ "t \"Misty\"\n" + "t \"Misty\"\n" + "e \"Fire\"\n" + "e \"Fire\"\n" + "e \"Fire\"\n" + "p \"Charizard\"\n"
	...
	public static String TEST_DECK2 = "e \"Lightning\"\n" + "e \"Lightning\"\n" + "p \"Pikachu\"\n"
			+ "e \"Lightning\"\n" + "e \"Lightning\"\n" + "e \"Lightning\"\n" + "p \"Pikachu\"\n" + "p \"Meowth\"\n"
			+ "e \"Lightning\"\n" + "t \"Tierno\"\n" + "t \"Tierno\"\n" + "e \"Lightning\"\n" + "e \"Lightning\"\n"
			+ "e \"Lightning\"\n" + "p \"Pikachu\"\n" + "e \"Lightning\"\n" + "e \"Lightning\"\n" + "e \"Lightning\"\n"
			+ "p \"Pikachu\"\n" + "p \"Meowth\"\n" + "e \"Lightning\"\n" + "t \"Tierno\"\n" + "t \"Tierno\"\n"
	...
	// Too Few
	public static String TEST_DECK3_BAD = "e \"Lightning\"\n" + "e \"Lightning\"\n" + "p \"Pikachu\"\n"
			+ "e \"Lightning\"\n" + "e \"Lightning\"\n" + "e \"Lightning\"\n" + "p \"Pikachu\"\n" + "p \"Meowth\"\n"
			+ "e \"Lightning\"\n" + "t \"Tierno\"\n" + "t \"Tierno\"\n" + "e \"Lightning\"\n" + "e \"Lightning\"\n"
			+ "e \"Lightning\"\n" + "p \"Pikachu\"\n" + "e \"Lightning\"\n" + "e \"Lightning\"\n" + "e \"Lightning\"\n"
			+ "p \"Pikachu\"\n" + "p \"Meowth\"\n" + "e \"Lightning\"\n" + "t \"Tierno\"\n" + "t \"Tierno\"\n"
	...
	// Too Many
	public static String TEST_DECK4_BAD = "e \"Lightning\"\n" + "e \"Lightning\"\n" + "p \"Pikachu\"\n"
			+ "e \"Lightning\"\n" + "e \"Lightning\"\n" + "e \"Lightning\"\n" + "p \"Pikachu\"\n" + "p \"Meowth\"\n"
			+ "e \"Lightning\"\n" + "t \"Tierno\"\n" + "t \"Tierno\"\n" + "e \"Lightning\"\n" + "e \"Lightning\"\n"
			+ "e \"Lightning\"\n" + "p \"Pikachu\"\n" + "e \"Lightning\"\n" + "e \"Lightning\"\n" + "e \"Lightning\"\n"
			+ "p \"Pikachu\"\n" + "p \"Meowth\"\n" + "e \"Lightning\"\n" + "t \"Tierno\"\n" + "t \"Tierno\"\n"
	...
	public static String TEST_DECK5 = "p \"Pikachu\"\n" + "e \"Lightning\"\n" + "p \"Pikachu\"\n" + "e \"Lightning\"\n"
			+ "e \"Lightning\"\n" + "e \"Lightning\"\n" + "p \"Pikachu\"\n" + "p \"Meowth\"\n" + "e \"Lightning\"\n"
			+ "t \"Tierno\"\n" + "t \"Tierno\"\n" + "e \"Lightning\"\n" + "e \"Lightning\"\n" + "e \"Lightning\"\n"
			+ "p \"Pikachu\"\n" + "e \"Lightning\"\n" + "e \"Lightning\"\n" + "e \"Lightning\"\n" + "p \"Pikachu\"\n"
			+ "p \"Meowth\"\n" + "e \"Lightning\"\n" + "t \"Tierno\"\n" + "t \"Tierno\"\n" + "e \"Lightning\"\n"
	...
	private String logout(WebClient webClient) throws MalformedURLException, IOException {
	...
	private String listPlayers(WebClient webClient) throws MalformedURLException, IOException {
	...
	private String challengePlayer(WebClient webClient, String string) throws MalformedURLException, IOException {
		WebRequest requestSettings = new WebRequest(new URL(URL_BASE + "AddChallenge"), HttpMethod.POST);

		requestSettings.setRequestParameters(new ArrayList());
		requestSettings.getRequestParameters().add(new NameValuePair("challengee", string));
	...
	private String listChallenges(WebClient webClient) throws MalformedURLException, IOException {
	...
	private String acceptChallenge(WebClient webClient, long challenge) throws MalformedURLException, IOException {
	...
	private String refuseChallenge(WebClient webClient, long challenge) throws MalformedURLException, IOException {
	...
	private String uploadDeck(WebClient webClient, String deck) throws MalformedURLException, IOException {
	...
	private String viewDeck(WebClient webClient) throws MalformedURLException, IOException {
		WebRequest requestSettings = new WebRequest(new URL(URL_BASE + "GetDeck"), HttpMethod.GET);
	...
	private String drawCard(WebClient webClient, long game) throws MalformedURLException, IOException {
	...
	private String viewBoard(WebClient webClient, long game) throws MalformedURLException, IOException {
	...
	private String viewHand(WebClient webClient, long game) throws MalformedURLException, IOException {
	...
	private String listGames(WebClient webClient) throws MalformedURLException, IOException {
	...
	private String retire(WebClient webClient, long game) throws MalformedURLException, IOException {
	...
	public void testLogoutSuccess() {
		try {
			...
			jsonText = login(webClient, "bob6", "fred6");
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));
	...
	public void testListPlayersSuccess() {
		try {
			...
			jsonText = login(webClient, "testListPlayersSuccessA", "testListPlayersSuccessAPass");
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));
			...
			dc = JsonPath.parse(jsonText);
			jPathResult = dc.read("players[?(@.username=='testListPlayersSuccessA')].username");
			...
			jsonText = login(webClient, "testListPlayersSuccessB", "testListPlayersSuccessBPass");
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));

			jsonText = listPlayers(webClient);
			dc = JsonPath.parse(jsonText);
			jPathResult = dc.read("players[?(@.username=='testListPlayersSuccessA')].user");
			Assert.assertEquals("testListPlayersSuccessA", jPathResult.get(0));
			jPathResult = dc.read("players[?(@.username=='testListPlayersSuccessB')].user");
	...
	public void testChallengePlayerSuccess() {
		try {
			...
			jsonText = login(webClient, "testChallengePlayerSuccessA", "testChallengePlayerSuccessAPass");
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));
			...
			jsonText = login(webClient, "testChallengePlayerSuccessB", "testChallengePlayerSuccessBPass");
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));
			...
			jsonText = listPlayers(webClient);
			dc = JsonPath.parse(jsonText);
			jPathResult = dc.read("players[?(@.username=='testChallengePlayerSuccessA')].playerId");

			jsonText = uploadDeck(webClient, TEST_DECK1);
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));

			jsonText = challengePlayer(webClient, jPathResult.get(0) + "");
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));
	...
	public void testChallengePlayerFailureNoDeck() {
		try {
			WebClient webClient = new WebClient();
			String jsonText = register(webClient, "testChallengePlayerFailureNoDeckA",
					"testChallengePlayerFailureNoDeckAPass");
			DocumentContext dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));

			jsonText = login(webClient, "testChallengePlayerFailureNoDeckA", "testChallengePlayerFailureNoDeckAPass");
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));

			jsonText = register(webClient, "testChallengePlayerFailureNoDeckB",
					"testChallengePlayerFailureNoDeckBPass");
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));

			jsonText = login(webClient, "testChallengePlayerFailureNoDeckB", "testChallengePlayerFailureNoDeckBPass");
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));
			...
			jsonText = listPlayers(webClient);
			dc = JsonPath.parse(jsonText);
			jPathResult = dc.read("players[?(@.username=='testChallengePlayerFailureNoDeckA')].playerId");

			jsonText = challengePlayer(webClient, String.valueOf(jPathResult.get(0)));
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("fail", dc.read("$['status']"));
	...
	public void testChallengePlayerFailureChallengeSelf() {
		try {
			WebClient webClient = new WebClient();
			String jsonText = register(webClient, "testChallengePlayerFailureChallengeSelfA",
					"testChallengePlayerFailureChallengeSelfAPass");
			DocumentContext dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));

			jsonText = login(webClient, "testChallengePlayerFailureChallengeSelfA",
					"testChallengePlayerFailureChallengeSelfAPass");
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));

			jsonText = register(webClient, "testChallengePlayerFailureChallengeSelfB",
					"testChallengePlayerFailureChallengeSelfBPass");
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));

			jsonText = login(webClient, "testChallengePlayerFailureChallengeSelfB",
					"testChallengePlayerFailureChallengeSelfBPass");
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));
			...
			jsonText = listPlayers(webClient);
			dc = JsonPath.parse(jsonText);
			jPathResult = dc.read("players[?(@.username=='testChallengePlayerFailureChallengeSelfB')].playerId");
	...
	public void testChallengePlayerFailureChallengeInvalidId() {
		try {
			WebClient webClient = new WebClient();
			String jsonText = register(webClient, "testChallengePlayerFailureChallengeInvalidA",
					"testChallengePlayerFailureChallengeInvalidAPass");
			DocumentContext dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));

			jsonText = login(webClient, "testChallengePlayerFailureChallengeInvalidA",
					"testChallengePlayerFailureChallengeInvalidAPass");
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));

			jsonText = register(webClient, "testChallengePlayerFailureChallengeInvalidB",
					"testChallengePlayerFailureChallengeInvalidBPass");
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));

			jsonText = login(webClient, "testChallengePlayerFailureChallengeInvalidB",
					"testChallengePlayerFailureChallengeInvalidBPass");
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));
			...
			jsonText = challengePlayer(webClient, String.valueOf(-12));
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("fail", dc.read("$['status']"));
	...
	public void testListChallengesSuccess() {
		try {
			...
			jsonText = challengePlayer(webClient, String.valueOf(idA));
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));
	...
	public void testListChallengesFailureNotLoggedIn() {
		try {
			WebClient webClient = new WebClient();
			String jsonText = register(webClient, "testListChallengesFailureNotLoggedInA",
					"testListChallengesFailureNotLoggedInAPass");
			DocumentContext dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));

			jsonText = register(webClient, "testListChallengesFailureNotLoggedInB",
					"testListChallengesFailureNotLoggedInBPass");
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));
	...
	public void testAcceptChallengesSuccess() {
		try {
			...
			jsonText = listChallenges(webClient);
			dc = JsonPath.parse(jsonText);
			query = "challenges[?(@['challenger']==" + idB + "  && @['challengee']==" + idA
					+ " && @['status']==3)].length()";
			jPathResult = dc.read(query);
			Assert.assertTrue(!jPathResult.isEmpty());
	...
	public void testAcceptChallengesFailureAcceptSomeoneElsesChallenge() {
		try {
			WebClient webClient = new WebClient();
			String jsonText = register(webClient, "testAcceptChallengesFailureAcceptSomeoneElsesChallengeA",
					"testAcceptChallengesFailureAcceptSomeoneElsesChallengeAPass");
			DocumentContext dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));
			...
			jsonText = register(webClient, "testAcceptChallengesFailureAcceptSomeoneElsesChallengeB",
					"testAcceptChallengesFailureAcceptSomeoneElsesChallengeBPass");
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));
			...
			jsonText = register(webClient, "testAcceptChallengesFailureAcceptSomeoneElsesChallengeC",
					"testAcceptChallengesFailureAcceptSomeoneElsesChallengeCPass");
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));
			...
			jsonText = listChallenges(webClient);
			dc = JsonPath.parse(jsonText);
			String query = "challenges[?(@['challenger']==" + idC + " && @['challengee']==" + idA
					+ " && @['status']==0)].id";
			jPathResult = dc.read(query);
			int ChallengeId = (Integer) ((Object) jPathResult.get(0));
			...
			jsonText = login(webClient, "testAcceptChallengesFailureAcceptSomeoneElsesChallengeB",
					"testAcceptChallengesFailureAcceptSomeoneElsesChallengeBPass");
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));
			...
			jsonText = listChallenges(webClient);
			dc = JsonPath.parse(jsonText);
			query = "challenges[?(@['challenger']==" + idC + "  && @['challengee']==" + idA
					+ " && @['status']==0)].length()";
			jPathResult = dc.read(query);
			Assert.assertTrue(!jPathResult.isEmpty());
	...
	public void testAcceptChallengesFailureAcceptOwnChallenge() {
		try {
			WebClient webClient = new WebClient();
			String jsonText = register(webClient, "testAcceptChallengesFailureAcceptOwnChallengeA",
					"testAcceptChallengesFailureAcceptOwnChallengeAPass");
			DocumentContext dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));
			...
			jsonText = register(webClient, "testAcceptChallengesFailureAcceptOwnChallengeB",
					"testAcceptChallengesFailureAcceptOwnChallengeBPass");
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));
			...
			jsonText = listChallenges(webClient);
			dc = JsonPath.parse(jsonText);
			String query = "challenges[?(@['challenger']==" + idB + " && @['challengee']==" + idA
					+ " && @['status']==0)].id";
			jPathResult = dc.read(query);
			int ChallengeId = (Integer) ((Object) jPathResult.get(0));
	...
	public void testRefuseChallengesSuccess() {
		try {
			...
			jsonText = challengePlayer(webClient, String.valueOf(idB));
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));
			...
			jPathResult = dc.read(query);
			Assert.assertTrue(!jPathResult.isEmpty());
			query = "challenges[?(@['challenger']==" + idC + "  && @['challengee']==" + idB
					+ " && @['status']==1)].length()";
			jPathResult = dc.read(query);
			Assert.assertTrue(!jPathResult.isEmpty());
	...
	public void testRefuseChallengesFailureRefuseSomeoneElsesChallenge() {
		try {
			WebClient webClient = new WebClient();
			String jsonText = register(webClient, "testRefuseChallengesFailureRefuseSomeoneElsesChallengeA",
					"testRefuseChallengesFailureRefuseSomeoneElsesChallengeAPass");
			DocumentContext dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));
			...
			jsonText = register(webClient, "testRefuseChallengesFailureRefuseSomeoneElsesChallengeB",
					"testRefuseChallengesFailureRefuseSomeoneElsesChallengeBPass");
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));
			...
			jsonText = register(webClient, "testRefuseChallengesFailureRefuseSomeoneElsesChallengeC",
					"testRefuseChallengesFailureRefuseSomeoneElsesChallengeCPass");
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));
			...
			jsonText = login(webClient, "testRefuseChallengesFailureRefuseSomeoneElsesChallengeB",
					"testRefuseChallengesFailureRefuseSomeoneElsesChallengeBPass");
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));
			...
			jsonText = login(webClient, "testRefuseChallengesFailureRefuseSomeoneElsesChallengeC",
					"testRefuseChallengesFailureRefuseSomeoneElsesChallengeCPass");
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));
	...
	public void testViewBoardFailureNotMyGame() {
		try {
			WebClient webClient = new WebClient();
			String jsonText = register(webClient, "testViewBoardFailureNotMyGameA",
					"testViewBoardFailureNotMyGameAPass");
			DocumentContext dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));
	...
	public void testDrawCardSuccess() {
		try {
			...
			// We know the content of the deck used, we know the order of cards,
			// just test two of them...
			// or do that when we test viewing hands so that this test doesn't
			// depend on the other working.
	...
	public void testViewHandSuccess() {
		try {
			...
			/*
			 * The definition of hand and card ids is poorly formed, so we don't have enough
			 * information to test for specifc ids. Darn.
			 */
	...
	public void testPlayPokemonToBenchSuccess() {
		try {
			WebClient webClient = new WebClient();
			String jsonText = register(webClient, "testPlayPokemonToBenchSuccessA",
					"testPlayPokemonToBenchSuccessAPass");
			DocumentContext dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));
			...
			// Test that a pokemon card ends up on bench after being drawn then
			// played
	...
	public void testPlayPokemonToBenchFailureNotMyGame() {
		try {
			WebClient webClient = new WebClient();
			String jsonText = register(webClient, "testPlayPokemonToBenchFailureNotMyGameA",
					"testPlayPokemonToBenchFailureNotMyGameAPass");
			DocumentContext dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));
			...
			jsonText = register(webClient, "testPlayPokemonToBenchFailureNotMyGameB",
					"testPlayPokemonToBenchFailureNotMyGameBPass");
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));
			...
			jsonText = login(webClient, "testPlayPokemonToBenchFailureNotMyGameA",
					"testPlayPokemonToBenchFailureNotMyGameAPass");
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));
			...
			jsonText = register(webClient, "testPlayPokemonToBenchFailureNotMyGameC",
					"testPlayPokemonToBenchFailureNotMyGameCPass");
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));
	...
	public void testRetireFromGameFailureNotMyGame() {
		try {
			WebClient webClient = new WebClient();
			String jsonText = register(webClient, "testRetireFromGameFailureNotMyGameA",
					"testRetireFromGameFailureNotMyGameAPass");
			DocumentContext dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));
			...
			jsonText = register(webClient, "testRetireFromGameFailureNotMyGameB",
					"testRetireFromGameFailureNotMyGameBPass");
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));
			...
			jsonText = login(webClient, "testRetireFromGameFailureNotMyGameA",
					"testRetireFromGameFailureNotMyGameAPass");
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));
			...
			jsonText = register(webClient, "testRetireFromGameFailureNotMyGameC",
					"testRetireFromGameFailureNotMyGameCPass");
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));
	...
	public void testUploadDeckFailSmallDeck() {
		try {
			...
			jsonText = login(webClient, "bob7", "fred7");
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));
	...
	public void testUploadDeckFailBigDeck() {
		try {
			...
			jsonText = login(webClient, "bob8", "fred8");
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));
	...
	public void testUploadDeckSuccess() {
		try {
			...
			jsonText = login(webClient, "bob9", "fred9");
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));
	...
	public void testUploadDeckSuccessRecoverFromFail() {
		try {
			...
			jsonText = login(webClient, "bob10", "fred10");
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));
	...
	public void testViewDeckSuccess() {
		try {
			...
			jsonText = login(webClient, "bob11", "fred11");
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));
			...
			for (int i = 0; i < cards.length; i++) {
				...
				Assert.assertEquals(type, dc.read("$['deck'][0]['cards'][" + i + "]['t']"));
				Assert.assertEquals(name, dc.read("$['deck'][0]['cards'][" + i + "]['n']"));
			}
	...
	public void testViewDeckFail() {
		try {
			...
			jsonText = login(webClient, "bob12", "fred12");
			dc = JsonPath.parse(jsonText);
			Assert.assertEquals("success", dc.read("$['status']"));
